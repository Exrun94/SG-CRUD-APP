...
import { StyledField, StyledForm, StyledLabel, ButtonWrapper, Button, InputWrapper, Error } from './FormData.styles'
...
const FormData = () => {
    const { setIsToggled } = useContext(FrameMotionContext)
